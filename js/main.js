/* ---- Menu Burger Button ---- */  
    ...
    $( document ).ready(function() {
        ...
        $('.menu-btn').click( function() {
            if(showMenu == false) {
                $('.menu-btn__burger, .nav, .menu-nav, .menu-nav__item').addClass('open');
                showMenu = true;
            } else {
                $('.menu-btn__burger, .nav, .menu-nav, .menu-nav__item').removeClass('open');
                showMenu = false;
            }
        })
        
        $('.menu-nav__link.contact').click(function() {
            $('.menu-btn__burger, .nav, .menu-nav, .menu-nav__item').removeClass('open');
                showMenu = false;
